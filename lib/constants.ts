...
export type Product = {
   ...
   * Links to it must be plain <a>, not <Link>: a client-side navigation
   * can't cross into another app.
   */
  ownSite?: boolean;
...
export const PRODUCTS: Product[] = [
  {
    ...
    // The DKayMRP site, a separate app - see MRP_SITE_URL in next.config.mjs.
    ownSite: true,
    highlights: [
